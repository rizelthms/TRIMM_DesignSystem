/**
 * TRIMM Design System - Color Token Editor Configuration
 * 
 * This file contains the editor configuration for the Color Token Editor widget
...
export function getProperties(
    _values: ColorTokenEditorPreviewProps,
