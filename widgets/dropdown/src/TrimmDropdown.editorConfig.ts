/**
 * TRIMM Design System - Dropdown Editor Configuration
 * 
 * This file contains the editor configuration for the TRIMM Dropdown widget
...
export function getProperties(
    _values: TrimmDropdownPreviewProps,
...
// export function check(_values: TrimmDropdownPreviewProps): Problem[] {
...
// export function getPreview(values: TrimmDropdownPreviewProps, isDarkMode: boolean, version: number[]): PreviewProps {
...
// export function getCustomCaption(values: TrimmDropdownPreviewProps, platform: Platform): string {
